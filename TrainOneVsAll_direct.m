function [ conf ] = TrainOneVsAll_direct( start_Idx,end_Idx, step)
...
%    
  ...
  if strcmp( conf.datasetName,'ILSVRC2010')
    ...
    path_filename_classifier_ready =  '/data/Dataset/LSVRC/2010/experiments/train300.val30.test150/binclassifiers/train300.blaall/ILSVRC2010.sdca.prob.classifier.ready.mat';
...
%      
   ...
   for ci= start_Idx:step:end_Idx %1:numClass      
    ...
    %   if ~exist(path_filename_model, 'file') || conf.isOverWriteResult== true
          fprintf('\n Selecting data of class %d: %s...',ci, ClassName);
