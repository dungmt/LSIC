...
gtruth_test_file = '/net/per610a/export/das09f/satoh-lab/dungmt/DataSet/LSVRC/2010/data/ILSVRC2010_validation_ground_truth.txt';
gt_test_label_vector = dlmread(gtruth_test_file);
[val_label_vector, idx] = sort(gt_test_label_vector);
