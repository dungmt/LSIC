...
%beta= 1e-4;
 ...
 %% maxComparisons= size(dictwords,2);
   ...
   %outputFullMat=true;
    ...
    dictwordsx=double(dictwords);
    imwordsx= double(imwords);
    ixx= double(ix);
    encoding = featpipem.lib.LLCEncodeHelper(dictwordsx, imwordsx, ixx, beta, logical(outputFullMat));
