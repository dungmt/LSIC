function CombineResultTestOnTest( conf)
%CombineResultTestOnVal: Ket hop ket qua tren tap Validation
    ...
    FileNameScoreMatrix = 'Caltech256.libsvm.pre.prob.bla5.test.mat'; % conf.val.FileNameScoreMatrix;
    ...
    if ~exist(path_filename_score_matrix,'file')
        ...
        for i=1:K
            ...
            filename_libsvm_val 	= fullfile(pathToSave,sprintf('%s.libsvm.pre.prob.bla5.test.mat',synset)); 		
