...
% NII
function LSIC5_SV( dataset, start_Idx,end_Idx, step,ci_start,ci_end,num_Child, isAuto, K_Pseudoclass, idx_alg)
   ...
   % Thuc hien training
     ...
     % Thuc hien testing
      ...
      conf  = pseudoClass.Test(conf,ci_start,ci_end);   
        % Ket hop ket qua lai  
    conf.isOverWriteResult= true;
      conf  = pseudoClass.Compose_SV(conf); 
