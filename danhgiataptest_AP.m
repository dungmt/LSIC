...
%     fprintf('finish !');
   ...
   VL_AP_INTERP_11 = zeros(1000,1);
    ...
    for i=1:K
            ...
            predicted_label_vector =  zeros(150000,1);
            scores=  zeros(150000,1);
            for j=1:150        
                str_id = num2str(j,'%.4d');                      
                ...
                predicted_label_vector(start : start + 999) = predicted_label;     
                scores(start : start + 999) = decision_values;
                fprintf('finish !');                
                start = start+ 1000;
            end
            
            label_vector = -ones(150000,1);
            sortidx = find(gt_test_label_vector==ILSVRC_IDs(i));
    ...
    % ghi ket qua
    fprintf('\n Writing result ...');
    filename_kqua_AP = 'ILSVRC2010.libsvm.pre.test.AP.mat';
