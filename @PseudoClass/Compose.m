...
%   Ket hop ma tran score voi USV
    ...
    fprintf('\n\t path_filename_score_matrix:%s',path_filename_score_matrix);
    fprintf('\n+----------------------------------------------------+');     
	fprintf('\n Compose SVDs matrix on Testing dataset...');
...
%         end
        ...
        fprintf('\n\t Saving score matrix to file: %s ...',path_filename_final_score_matrix);
...
%         
    ...
    ready=1;
    save(conf.svr.path_filename_compose_ready, 'ready');
