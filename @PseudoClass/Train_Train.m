function conf  = Train_Train(obj,conf,ci_start,ci_end)
...
%             path_filename_instance_matrix = conf.val.path_filename;
            isPreComp = false;
            filename_val_selected	= conf.train.filename;
           path_filename_instance_matrix   = fullfile(conf.experiment.pathToBinaryClassifer,    filename_val_selected)        
