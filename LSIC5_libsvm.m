...
% NII
function LSIC5_libsvm( dataset, start_Idx,end_Idx, step,ci_start,ci_end,num_Child, isAuto)
...
%     step    = str2num(step);
    ...
    conf.svr.solver = 'libsvm'; % 'liblinear' 'libsvm'
    conf.svr.preCompKernel = true;
