...
% NII
function LSIC5_scda( dataset, start_Idx,end_Idx, step,ci_start,ci_end,num_Child, isAuto)
...
%     step    = str2num(step);
    ...
    conf.svm.solver = 'sdca'; % 'vl_svmtrain {'sgd', 'sdca'}',  'liblinear', 'libsvm'    
...
%     [ conf ] = TrainOneVsAll_scda( conf , start_Idx,end_Idx, step);
